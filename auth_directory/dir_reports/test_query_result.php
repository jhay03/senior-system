          ...
          <div class="box-body no-padding" style="font-size:12px;">
            ...
            <table id="example1" class="table table-bordered table-striped" style="margin-top:0 !important;" width="100%">
              ...
              <tbody>
                  <?php
                    $lbaArray = array();
                    $lbaQuery = $mysqli -> query("SELECT
                                                  lbu_area,
                                                  a.data_lburebate,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'January' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `jan`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'February' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `feb`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'March' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `mar`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'April' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `apr`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'May' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `may`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'June' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `jun`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'July' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `jul`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'August' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `aug`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'September' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `sep`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'October' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `oct`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'November' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `nov`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'December' AND data_doctor='$mdname') THEN a.`data_amount`
                                                  END)) AS `dec`
                                              FROM
                                                  `mdc_senior_dummy`.`senior_data` as a
                                                  INNER JOIN mdc_senior.lbu_rebatedb as b
                                                  ON a.data_lburebate = b.lbu_code
                                              WHERE
                                                  lbu_dname='$mdname' AND lbu_year='2018' AND lbu_quarter='Q1' AND
                                                  (a.`data_year` = '$tyear') AND data_doctor='$mdname'
                                                  GROUP BY data_lburebate");
                      while($lbaRes = $lbaQuery -> fetch_assoc()){
                        $sumMD = array();
                        $sumArea = array();
                  ...
                  <tr>
                      ...
                      <?php
                        for($i = $fmonth; $i <= $tmonth; $i++){
                          $totalMD = $lbaRes[strtolower(date('M', mktime(0, 0, 0, $i, 10)))];
                          $totalArea = getAmountTotalLba($lbacode,date('F', mktime(0, 0, 0, $i, 10)),$tyear);
                          $sumMD[] = str_replace(',','',$totalMD);
                          $sumArea[] = $totalArea;
                      ?>
                      <td style="white-space: nowrap;text-align:right;"><?php echo number_format((float)$totalMD,2);?></td>
              ...
              <tbody>
                  <?php
                    ...
                    $lbaQuery = $mysqli -> query("SELECT
                                                  ...
                                                  a.data_lburebate,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'January') THEN a.`data_amount`
                                                  END)) AS `jan`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'February') THEN a.`data_amount`
                                                  END)) AS `feb`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'March') THEN a.`data_amount`
                                                  END)) AS `mar`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'April') THEN a.`data_amount`
                                                  END)) AS `apr`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'May') THEN a.`data_amount`
                                                  END)) AS `may`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'June') THEN a.`data_amount`
                                                  END)) AS `jun`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'July') THEN a.`data_amount`
                                                  END)) AS `jul`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'August') THEN a.`data_amount`
                                                  END)) AS `aug`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'September') THEN a.`data_amount`
                                                  END)) AS `sep`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'October') THEN a.`data_amount`
                                                  END)) AS `oct`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'November') THEN a.`data_amount`
                                                  END)) AS `nov`,
                                                  SUM((CASE
                                                      WHEN (a.`data_month` = 'December') THEN a.`data_amount`
                                                  END)) AS `dec`
                                              FROM
                                                  `mdc_senior_dummy`.`senior_data` as a
                                                  INNER JOIN mdc_senior.lbu_rebatedb as b
                                                  ON a.data_lburebate = b.lbu_code
                                              WHERE
                                                  data_lburebate NOT IN('".implode("','",$lbaArray)."') AND data_year='$tyear'
                                                  AND data_doctor='$mdname'
                                                  GROUP BY data_lburebate");
                      while($lbaRes = $lbaQuery -> fetch_assoc()){
                        $lbacode = $lbaRes['data_lburebate'];
                        $lbaArea = $lbaRes['lbu_area'];
                        $sumMD = array();
                        $sumArea = array();
                  ?>
                  <tr>
