  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          <a href="../dir_data_sanitation/data-sanitation-not-masterlist.php" class="bg-blue"><i class="fa fa-clipboard-check"></i> <span>Non-Masterlist Sanitation</span></a>
        </li>
  ...
  function reloadDatatable(district_list, doctor_list){
    ...
    var table = $('#example2').DataTable( {
      ...
      initComplete: function () {
        this.api().columns([0,1,3]).every( function (index ) {
