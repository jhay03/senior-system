    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <!-- <select id="doctor_listx" name="doctor_listx" class="form-control"> -->
            <?php
                  // $districtQuery = $mysqli -> query("SELECT sanit_mdname FROM db_sanitation ORDER BY sanit_mdname ASC");
                  // while($districtRes = $districtQuery -> fetch_assoc()){
            ?>
            <!-- <option value="<?//php echo $districtRes['sanit_mdname'];?>"><?//php echo $districtRes['sanit_mdname'];?></option> -->
          <?//php }?>
          <!-- </select> -->
        </div>
      </div>
