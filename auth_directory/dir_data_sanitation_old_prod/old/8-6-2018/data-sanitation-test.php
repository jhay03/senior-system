...
$("#selectColShowHide").selectpicker('val', [0,1,2,3,4,5])
  ...
  $("#btnGetTableData").click(function (e){
    ...
    if(raw_id_array.length > 0){
      ...
      setTimeout(function(){
        $('#example3').DataTable( {
            ...
            ordering: false,
            scrollCollapse: true,
            ajax: "includes/controller/check_data_if_sanitized.php?id="+raw_id_array,
            responsive: true,
            searching: false,
            autoWidth: true,
            processing: true,
        ...
        $('#tableUnclean').DataTable( {
            ...
            ordering: false,
            scrollCollapse: true,
            ajax: "includes/controller/view_unclean_data.php?id="+raw_id_array,
            responsive: false,
            searching: false,
            autoWidth: false,
            processing: false
   ...
   $("#btnConfirm").click(function (e){
    ...
    console.log(doctor_list);
     ...
     var dataString = "token=" + token + "&cmd=" + cmd + "&raw_id=" + raw_id_array + "&doctor_list=" + doctor_orig_name;
     $.ajax({
       type: "POST",
       url: "includes/controller/index.php",
       data: dataString,
 ...
 $("#btnGetTableDataUnclassified").click(function (e){
  ...
  $("#btnUnclassified").click(function (e){
   ...
   function getSanitizedData(district_list, doctor_list){
     $('#tblSanitized').dataTable().fnDestroy();
     var table = $('#tblSanitized').DataTable( {
       scrollY: "45vh",
       scrollX: true,
       deferRender: true,
       paging: false,
