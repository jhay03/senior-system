...
$(document).ready(function() {
     $('#example2 thead tr td').each( function (i) {
        ...
        if(title == "Sanitized Name" || title == "LN" || title == "Location" || title == "Branch Name"){
          ...
          $(this).html( '<div class="input-group input-group-sm" style="width: 100% !important;">'
                        ...
                        + '<button type="button" class="btn btn-info btn-flat" data-index="'+i+'" data-fidentifier="'+filterID+'" style="height: 25px !important;padding: 0px 10px !important;"><i class="fa fa-search"></i></button>'
                        + '<button type="button" class="btn btn-danger btn-flat" data-index="'+i+'" data-fidentifier="'+filterID+'" style="height: 25px !important;padding: 0px 10px !important;"><i class="fa fa-times"></i></button>'
                        + '</span></div>' );
        }
     });
